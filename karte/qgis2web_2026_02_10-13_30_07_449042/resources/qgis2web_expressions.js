...
function exp_GeteiltesDeutschland_3rule0_eval_expression(context) {
    // name = 'Alte Bundesrepublik Deutschland und Westberlin'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('name')  == 'Alte Bundesrepublik Deutschland und Westberlin');
    } else {
        return (feature.get('name')  == 'Alte Bundesrepublik Deutschland und Westberlin');
    }
}
...
function exp_GeteiltesDeutschland_3rule1_eval_expression(context) {
    // name = 'Ehemalige DDR'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('name')  == 'Ehemalige DDR');
    } else {
        return (feature.get('name')  == 'Ehemalige DDR');
    }
}