...
var lyr_DividedGermany19491990_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/DividedGermany19491990_2_0.png" /> Alte Bundesrepublik Deutschland und Westberlin<br />\
    <img src="styles/legend/DividedGermany19491990_2_1.png" /> Ehemalige DDR<br />' });
...
var lyr_OccupationZones19451949_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/OccupationZones19451949_3_1.png" /> UdSSR<br />\
    <img src="styles/legend/OccupationZones19451949_3_2.png" /> UK<br />\
    <img src="styles/legend/OccupationZones19451949_3_3.png" /> USA<br />\
    <img src="styles/legend/OccupationZones19451949_3_4.png" /> <br />' });
...
lyr_DividedGermany19491990_2.set('fieldLabels', {'fid': 'hidden field', 'name': 'no label', 'neuer name': 'hidden field', 'gesamt_strassen': 'inline label - always visible', 'name_english': 'no label', });
lyr_OccupationZones19451949_3.set('fieldLabels', {'fid': 'hidden field', 'BZ': 'hidden field', 'Besatzungsmacht': 'inline label - always visible', 'Occupying Power': 'hidden field', 'strassen_gesamt': 'inline label - always visible', 'Besatzer_Label': 'no label', 'Occupier_Label': 'no label', });
