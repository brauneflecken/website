...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [441456.497014, 5914765.555030, 1975629.431838, 7393486.456065], maxZoom: 12, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
...
map.getView().fit([441456.497014, 5914765.555030, 1975629.431838, 7393486.456065], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Nazi Legacies in German Public Spaces</h2>';
        return titleElement;
    })(),
