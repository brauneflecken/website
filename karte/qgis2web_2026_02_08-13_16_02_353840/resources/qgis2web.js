...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 12, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
...
map.getView().fit([315852.945983, 6110655.211892, 2045137.404861, 7401166.002099], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">NS-Vergangenheit in Straßennamen</h2>';
        return titleElement;
    })(),
